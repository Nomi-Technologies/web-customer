    ...
    return Container(
      ...
      child: Column(children: [
        Container(
          ...
          child: Row(children: [
            Expanded(child: Text(this.dish.name, style: theme.primaryTextTheme.headline1)),
            Container(alignment: Alignment.center, child: IconButton(
              color: Colors.blue,
              hoverColor: Colors.transparent,
              highlightColor: Colors.transparent,
              splashColor: Colors.transparent,
              icon: Icon(Icons.info),
              onPressed: () => print('Allergen info'),
            ))
          ])
        ),
        Container(
          child: Row(children: [
            Expanded(child: Text(this.dish.description, style: theme.primaryTextTheme.headline1)),
            Container(alignment: Alignment.center, child: IconButton(
              color: Colors.blue,
              hoverColor: Colors.transparent,
              highlightColor: Colors.transparent,
